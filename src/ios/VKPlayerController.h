 ...
 */
- (void)player:(VKPlayerController *)player didChangeState:(VKDecoderState)state errorCode:(VKError)errCode;
 ...
 */
- (void)player:(VKPlayerController *)player didStartRecordingWithPath:(NSString *)recordPath;
 ...
 */
- (void)player:(VKPlayerController *)player didStopRecordingWithPath:(NSString *)recordPath error:(VKErrorRecorder)error;
#endif
...
/**
 *  Updates the buffer to catch up with realtime stream
 */
